...
//*****************************************************************************************
//THIS CLASS CONTROLL ALL THE FUNCTIONS IN THE MENU
//*****************************************************************************************
...
void Lib::getdata()
{
                    int i;
                    fflush(stdin);
                    headMessage("Enter Book Details");
                    //cout<<"\n\t\tEnter the details :-\n";
                    cout<<"\n\t\t\t\t\t\tEnter Book's Name : ";
...
//*****************************************************************************************
//FUNCTION TO DISPLAY MAIN MENU / USER LOGIN
//*****************************************************************************************
void Lib::get()
{
   int i;
